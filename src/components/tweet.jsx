  ...
  return (
    <div className="tweet">
      ...
      <div>
        ...
        <TweetText text="Bonjour suis développeur fullstack pour vos projets " />
        <TweetActions />
      </div>
...
function TweetSms2() {
  return (<div className="tweet">
    ...
    <div>
      <TweetTitle text="Kaji" icon="src/images/Group.svg" strong="Dev 1h." />
      <TweetText text="Bonjour suis développeur fullstack pour vos projets de digitalisation " />
      <TweetActions />
    </div>
